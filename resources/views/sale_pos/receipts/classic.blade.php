...
<div class="row" style="color: #000000 !important;">
 ...
 <table class="table table-responsive table-slim">
    <thead>
        <tr>
            <th width="10%" style="border: 1px solid black; text-align: center;">S/N</th> <!-- Moved Serial Number to the first column -->
            <th width="{{$p_width}}%" style="border: 1px solid black;">{{$receipt_details->table_product_label}} Items</th>
            <th class="text-right" width="15%" style="border: 1px solid black; text-align: center;">{{$receipt_details->table_qty_label}}</th>
            <th class="text-right" width="15%" style="border: 1px solid black; text-align: center;">{{$receipt_details->table_unit_price_label}}</th>
            @if(!empty($receipt_details->discounted_unit_price_label))
                <th class="text-right" width="10%" style="border: 1px solid black; text-align: center;">{{$receipt_details->discounted_unit_price_label}}</th>
            @endif
            @if(!empty($receipt_details->item_discount_label))
                <th class="text-right" width="10%" style="border: 1px solid black; text-align: center;">{{$receipt_details->item_discount_label}}</th>
            @endif
            <th class="text-right" width="15%" style="border: 1px solid black; text-align: center;">{{$receipt_details->table_subtotal_label}}</th>
        </tr>
    </thead>
    <tbody>
        @forelse($receipt_details->lines as $index => $line)
            <tr>
                <td class="text-right" style="border: 1px solid black; text-align: center;">{{$index + 1}}</td> <!-- Display the serial number (index + 1) -->
                <td style="border: 1px solid black; ">
                    <!-- ... (previous product information code) ... -->
                ...
                <td class="text-right" style="border: 1px solid black; text-align: center;">{{$line['unit_price_before_discount']}}</td>
                @if(!empty($receipt_details->discounted_unit_price_label))
                    <td class="text-right" style="border: 1px solid black; text-align: center;">
                ...
                @endif
                <td class="text-right" style="border: 1px solid black; text-align: center;">{{$line['line_total']}}</td>
            </tr>
            <!-- ... (previous product modifiers code) ... -->
        @empty
            <tr>
